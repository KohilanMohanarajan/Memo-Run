...
public String [] get_question(){
  ...
  if(question_answered == false){
    ...
    int diffchoose = PApplet.parseInt(random(1, diffrange+1));
...
public boolean check_answer(String candidate){
...
class Star{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Memo" };
    if (passedArgs != null) {
